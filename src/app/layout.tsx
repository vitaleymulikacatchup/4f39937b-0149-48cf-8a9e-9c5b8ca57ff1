...
export const metadata: Metadata = {
  title: "AutoDealer Pro - Premium Car Dealership | New & Pre-Owned",
  description: "Find your perfect car at AutoDealer Pro. Premium vehicles, competitive financing, expert service, and unmatched customer satisfaction. Browse our inventory today.",
  keywords: "car dealership, new cars, used cars, auto financing, car sales, premium vehicles, automotive",
